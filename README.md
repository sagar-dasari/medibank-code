...
3. The script will process all `.txt` files in the directory and subdirectories. 
4. The word frequencies will be displayed in descending order.

## Functions:
- `count_strings_in_directory(directory_path)`: Counts words in `.txt` files and returns a dictionary of words with their occurrences.
